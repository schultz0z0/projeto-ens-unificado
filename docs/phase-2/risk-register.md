...
| F2-R-06 | sobrescrita silenciosa por edição concorrente | alto | versão do agregado, `If-Match`, `version_conflict` e UX de recarregar/reaplicar sem descartar valores locais; painéis avançam a versão compartilhada | médio; concorrência API/DB real e E2E pendentes | Backend/Frontend |
...
| F2-R-11 | lista lenta ou bundle frontend regressivo | médio | payload resumido, índices, 5.000 campanhas, lazy loading e medição de bundle/p95 | médio; UI das Tasks 11–13 implementada, volume/p95 da Task 14 pendentes | Frontend/Backend |

...
| F4-R-10 | descrição de tool grande ou ambígua induz uso incorreto pelo modelo | médio | ferramentas pequenas, nomenclatura estável, skill e contrato sistêmico da Bridge revisados; RED/GREEN para a criação estrita | Hermes Runtime/Bridge | `bridge_contract_tested_vps_pending` |

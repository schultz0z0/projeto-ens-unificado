...
| F4-R-24 | referência da skill citar ações de conteúdo sem congelar seus campos canônicos | alto | documentar wire shape exato, proibir aliases e manter regressão do pacote gerenciado | Hermes Runtime | `skill_1_2_1_local_validated_vps_pending` |

...
export GATEWAY_HEALTH_URL="${GATEWAY_HEALTH_URL:-}"
export GATEWAY_HEALTH_TIMEOUT="${GATEWAY_HEALTH_TIMEOUT:-3}"
...
HERMES_ENV_EXPORTS="$(build_hermes_exports \
  HERMES_HOME HERMES_DATA_PATH HERMES_KANBAN_PORT GATEWAY_HEALTH_URL GATEWAY_HEALTH_TIMEOUT HERMES_ARTIFACTS_DIR HERMES_ARTIFACT_MAX_BYTES HERMES_IMAGE_SUPABASE_DELETE_LOCAL_CACHE \
